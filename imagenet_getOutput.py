'''
Get Logit Outputs for ImageNet
...
def test(val_loader, model, criterion, epoch, use_cuda):
    ...
    # for k in Softmax_Outs_tem_Dict:
        # Softmax_Outs_tem_Dict[k] = Softmax_Outs_tem_Dict[k].cpu()

    torch.save(Outputs, args.checkpoint+'/Logit Outputs of {}.pt'.format(args.arch))
    torch.save(Softmax_Outs, args.checkpoint+'/Softmax Outputs of {}.pt'.format(args.arch))
    torch.save(Softmax_Outs_tem_Dict, args.checkpoint+'/Softmax_Outs_tem_Dict of {}.pt'.format(args.arch))
    
    torch.save(Targets, args.checkpoint+'/Targets of {}.pt'.format(args.arch))

# cifar
python cifar_getLogits.py -a vgg19_bn --epochs 300 --schedule 150 225 --gamma 0.1 --checkpoint Ensemble/cifar10/vgg19_bn --gpu-id 0 &
python cifar_getLogits.py -a resnet --depth 110 --epochs 300 --schedule 150 225 --gamma 0.1 --wd 1e-4 --checkpoint Ensemble/cifar10/resnet-110 --gpu-id 1 &
python cifar_getLogits.py -a densenet --depth 100 --growthRate 12 --train-batch 64 --epochs 300 --schedule 150 225 --wd 1e-4 --gamma 0.1 --checkpoint Ensemble/cifar10/densenet-bc-100-12 --gpu-id 2 &
python cifar_getLogits.py -a resnet --dataset cifar100 --depth 110 --epochs 300 --schedule 150 225 --gamma 0.1 --wd 1e-4 --checkpoint Ensemble/cifar100/resnet-110 --gpu-id 3 &
python cifar_getLogits.py -a densenet --dataset cifar100 --depth 100 --growthRate 12 --train-batch 64 --epochs 300 --schedule 150 225 --wd 1e-4 --gamma 0.1 --checkpoint Ensemble/cifar100/densenet-bc-100-12 --gpu-id 4 &
python cifar_getLogits.py -a vgg19_bn --dataset cifar100 --checkpoint Ensemble/cifar100/vgg19_bn --epochs 300 --schedule 150 225 --gamma 0.1 --gpu-id 5 &
